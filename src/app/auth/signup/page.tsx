...
export const metadata: Metadata = {
    title: "Next.js SignUp Page | CRM - Next.js Dashboard Template",
    description: "This is Next.js SignUp Page CRM Dashboard Template",
    // other metadata
};
                ...
                <div className="flex flex-wrap items-center">
                    <div className="hidden w-full xl:block xl:w-1/2">
                        <div className="px-26 py-17.5 text-center">
                            <Link className="mb-5.5 inline-block" href="/" prefetch={false}>
                                <Image
                            ...
                            <form>
                                ...
                                <div className="mt-6 text-center">
                                    <p>
                                        ...
                                        <Link href="/auth/signin" prefetch={false} className="text-primary">
                                            Sign in
                                        </Link>
                                    </p>
                                </div>
